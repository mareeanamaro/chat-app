...
export default function Chat(props) {
    ...
    useEffect(() => {
        // set navbar title to the user's name
        ...
        if (isConnected) {
            // query messages and order them by date
            ...
            // delete previous messages from async storage
            deleteMessages();
            // save new messages in async storage
            saveMessages();
